                    ...
                    <q-card class="my-card" flat no-border>                 
                        <q-card-section horizontal>        
                            <q-card-section class="q-pt-xs">
                                ...
                                <div class="text-subtitle2">Sección donde puede encontrar documentos como reglamentos, acta constitutiva, etc.</div>                            
                            </q-card-section>
                        </q-card-section>
                    </q-card>
                </q-card-section>
...
export default defineComponent({
    ...
    setup() {
        ...
        return {      
            ...
            secciones,    
            go:  (ruta) => { 
                router.push(`/condominos/contenedorusr/2/${ruta}`);
            } 
        }
