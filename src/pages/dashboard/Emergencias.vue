    ...
    <q-page>    
        <div class="fondo1">
            <q-card class="esqredonda">
                    ...
                    <q-card class="my-card" flat no-border>                 
                        <q-card-section horizontal>        
                            <q-card-section class="q-pt-xs">
                                <div class="text-h6"> 
                                <q-icon color="primary" size="30px" name="speaker_phone" />  Numerós de Emergencias  </div>     
                                <div class="text-subtitle2">Sección donde se muestra el listado de úmeros de emergencias del condominio.</div>                            
                            </q-card-section>
                        </q-card-section>
                    </q-card>
                </q-card-section>
                <q-card-section class="q-pa-md  q-gutter-md">
                    <q-list bordered>
                        <q-item v-for="seccion in secciones" :key="seccion.id" class="q-my-sm" clickable v-ripple @click="go(seccion.numero)">
                            <q-item-section avatar>
                              <q-icon :name="seccion.icono" color="teal" />                            
                            </q-item-section>

                            <q-item-section>
                                <q-item-label class="text-subtitle1"> 
                                    <span class="text-subtitle1 text-weight-bold ">{{ seccion.alias }}</span>
                                </q-item-label> 
                            </q-item-section>
