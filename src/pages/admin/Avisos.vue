                    ...
                    <q-card class="my-card" flat no-border>                 
                        <q-card-section horizontal>        
                            <q-card-section class="q-pt-xs">
                                <div class="text-h6"> 
                                <q-icon color="primary" size="30px" name="notifications" />  Avisos  </div>     
                ...
                <q-card-section>
                    <div>
                        ...
                        >
                            ...
                            <q-tab name="avisos"  label="Listado de Avisos" />
                        </q-tabs>

                        <q-separator />

                        <q-tab-panels v-model="tab" animated>
                            <q-tab-panel name="avisos">
                                <TablaAvisos></TablaAvisos>                                
                            </q-tab-panel>
                        </q-tab-panels>
...
export default defineComponent({
    name: 'Avisos',
    components: {
        TablaAvisos: defineAsyncComponent(() => import('../components/admin/EdicionAvisos/Aviso.vue')),
    },
